                ...
                ?>
                        ...
                        <tr class="my-3 trClient<?= ($nbLine % 2) + 1 ?>">
                            ...
                            <td class="text-center">
                                <!-- <a href="/Dashboard/Clients/Edit?id=<?= $client->id ?>"><i class="fa-solid fa-pen"></i></a> &emsp; -->
                            <a href="/Dashboard/Clients/Getback?id=<?=$client->id?>">
