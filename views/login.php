...
<main>
    ...
    <div class="mt-2">
        <form method="post" class="d-flex flex-column align-items-center" id="loginForm">
            ...
            <small class="text-center <?= ($error['password'] ?? false) ? 'text-danger' : '' ?>"><?= $error['password'] ?? 'Le mot de passe doit contenir au minimum : 1 minuscule, 1 majuscule, 1 caractère spécial et entre 6 et 15 caractères' ?></small>
