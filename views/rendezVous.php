        ...
        <div class="row flex-column">
            ...
            <div class="col-12 col-lg-5 p-0 mx-auto">
                ...
                <form class="d-flex flex-column justify-content-center w-auto" method="post">
                    ...
                    <?php } ?>
                    <small <?= ($error['presta'] ?? false) ? 'class="text-danger"' : '' ?>><?= $error['presta'] ?? 'Veuillez sélectionnez maximum 3 prestations mais au moins 1' ?></small>
                    ...
                    <div class="row">
                        <div class="col-12 d-flex justify-content-center mt-3 ">
                            <!-- DAY -->
                            <input type="date" name="day" id="appointmentDay" class="inputForm rounded" required value="<?= date('Y-m-d') ?>" min="<?= date('Y-m-d') ?>">
